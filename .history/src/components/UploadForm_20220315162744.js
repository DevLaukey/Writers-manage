...
function Form() {
  ...
  const [debounceKey] = useDebouncedCallback(key, 1000);
  const clearForm = () => {
    return(
      setFiles(),
      setCostPerPage(""),
  ...
  const uploadForm = (event) => {
    ...
    if (
      ...
      alert.show("Kindly fill in all the information!", {
        title: "Error",
      });
    } else {
      const data = {
      ...
      <Container component="main" maxWidth="xs">
        ...
        >
          ...
          <Box component="form" noValidate sx={{ mt: 1 }}>
            ...
            <DropzoneArea clearOnUnmount="true" onDrop={(files) => setFiles(files)} key={debounceKey}/>
